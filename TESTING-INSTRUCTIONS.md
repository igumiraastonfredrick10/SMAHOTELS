...
2. Fill out the booking form with test data:
   ...
   - Phone: Your WhatsApp number (with country code, e.g., +256787437223)
...
- "Subject": Booking Confirmed - Paradise Hotel - Booking #[ID]
...
- Customer phone number MUST include country code (e.g., +256787437223)
...
- Check phone number format: +256787437223 (no spaces)
